...
exports.ReportContentGeneratorService = void 0;
// @ts-ignore
const openai_1 = __importDefault(require("openai"));
const openai = new openai_1.default({
    apiKey: process.env.OPENAI_API_KEY
});
class ReportContentGeneratorService {
    /**
...
`;
     ...
     */
    async generateSummaryCards(input) {
        ...
        const eventSections = input.sections.filter(s => s.title.toLowerCase().includes('evento') ||
        ...
        const financialSections = input.sections.filter(s => s.title.toLowerCase().includes('financeiro') ||
     ...
     */
    async generateQuickInsight(section) {
        const prompt = `
...
`;
     ...
     */
    async generateCompleteReport(input) {
        const finalSections = [];
...
exports.ReportContentGeneratorService = ReportContentGeneratorService;
exports.default = new ReportContentGeneratorService();
